...
export default function Filters() {
  ...
  return (
    <div className="lg:w-[300px] overflow-scroll mobile-scroll relative">
      <h2 className="text-[#6AAEBD] text-3xl font-semibold pb-3">Filters</h2>
      <hr className="w-[80%] mx-auto" />
      <section className="space-y-5 pt-2 px-4 text-left mt-5 ">
        <label
